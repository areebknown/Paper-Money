        ...
        <div className="bg-[#0f172a] border border-white/5 rounded-[2rem] p-8">
            ...
            {state === 'success' && (
                <div className="space-y-4">
                    ...
                    <p className="text-slate-400 text-[11px] leading-relaxed">Returning you to the signup form...</p>
...
// Outer page — wraps inner component in Suspense as required by Next.js
    ...
    return (
        <div className="min-h-screen bg-[#020617] flex items-center justify-center p-6 relative overflow-hidden">
            ...
            >
                ...
                <Suspense
                    fallback={
                        <div className="bg-[#0f172a] border border-white/5 rounded-[2rem] p-8 space-y-4">
                            <Loader2 size={40} className="animate-spin text-blue-400 mx-auto" />
                            <p className="text-slate-500 text-[10px] uppercase font-bold tracking-widest">Loading...</p>
                        </div>
                    }
                >
                    <CallbackContent />
