...
export default function LandingPage() {
    ...
    const containerVariants = {
        ...
        show: {
            opacity: 1,
            transition: {
                staggerChildren: isMobile ? 0 : 0.13,
    ...
    const cardVariants = {
        hidden: { opacity: 0, y: isMobile ? 0 : 56, scale: isMobile ? 1 : 0.96 },
        show: {
            opacity: 1,
            y: 0,
            scale: 1,
    ...
    const fadeUpVariants = {
        hidden: { opacity: 0, y: isMobile ? 0 : 28 },
        show: {
            opacity: 1,
            y: 0,
            transition: {
    ...
    // Prevent hydration mismatch on initial render for animations
    if (!mounted) return <div className="min-h-screen bg-[#020617]" />;

    return (
        <div className="min-h-screen bg-[#020617] text-white overflow-x-hidden selection:bg-yellow-500/30">
            {/* Global Background Glows (GPU Accelerated & Non-Blur) */}
            <div className="fixed top-[-10%] right-[-10%] w-[60%] h-[60%] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-900/15 via-blue-900/5 to-transparent rounded-full pointer-events-none transform-gpu" />
            <div className="fixed bottom-[-10%] left-[-10%] w-[60%] h-[60%] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-yellow-900/15 via-yellow-900/5 to-transparent rounded-full pointer-events-none transform-gpu" />

            {/* Navigation */}
            <nav className="relative z-50 px-6 py-6 border-b border-slate-900/50 backdrop-blur-md sticky top-0 transform-gpu">
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        <Image src={LOGO_URL} alt="Bid Wars" width={160} height={40} className="h-10 w-auto object-contain" priority />
                    </div>
            ...
            <section className="relative pt-32 pb-32 px-6">
                <div className="max-w-7xl mx-auto text-center">
                    <motion.h1
                        ...
                        transition={{ duration: isMobile ? 0.3 : 0.8, ease: EASE_OUT_EXPO, delay: isMobile ? 0 : 0.1 }}
                    ...
                    <motion.p
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: isMobile ? 0.3 : 0.8, ease: EASE_OUT_EXPO, delay: isMobile ? 0 : 0.22 }}
                    ...
                    <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: isMobile ? 0.3 : 0.8, ease: EASE_OUT_EXPO, delay: isMobile ? 0 : 0.36 }}
            ...
            <section className="py-24 bg-slate-950/50 border-y border-slate-900 px-6 overflow-hidden">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <motion.div variants={cardVariants} className="p-8 rounded-3xl bg-[#090F22] border border-slate-800 group md:hover:border-[#FBBF24]/50 transition-colors text-center relative overflow-hidden">
                            ...
                            <div className="w-16 h-16 bg-slate-950 border border-slate-800 rounded-2xl flex items-center justify-center text-[#FBBF24] mb-6 mx-auto md:group-hover:scale-110 md:group-hover:bg-[#FBBF24]/10 transition-all shadow-xl">
                                <Gavel size={32} />
                            </div>
                        ...
                        <motion.div variants={cardVariants} className="p-8 rounded-3xl bg-[#090F22] border border-slate-800 group md:hover:border-emerald-500/50 transition-colors text-center relative overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-b from-emerald-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                            <div className="w-16 h-16 bg-slate-950 border border-slate-800 rounded-2xl flex items-center justify-center text-emerald-400 mb-6 mx-auto md:group-hover:scale-110 md:group-hover:bg-emerald-500/10 transition-all shadow-xl">
                                <TrendingUp size={32} />
                            </div>
                        ...
                        <motion.div variants={cardVariants} className="p-8 rounded-3xl bg-[#090F22] border border-slate-800 group md:hover:border-purple-500/50 transition-colors text-center relative overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-b from-purple-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                            <div className="w-16 h-16 bg-slate-950 border border-slate-800 rounded-2xl flex items-center justify-center text-purple-400 mb-6 mx-auto md:group-hover:scale-110 md:group-hover:bg-purple-500/10 transition-all shadow-xl">
            ...
            <section className="py-24 px-6 relative">
                <div className="max-w-5xl mx-auto">
                    ...
                    >
                        <div className="absolute top-0 right-0 w-64 h-64 bg-yellow-500/10 rounded-full pointer-events-none transform-gpu" style={{ filter: 'blur(100px)' }} />
                        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
                            ...
                            >
                                <motion.div variants={cardVariants} className="p-4 bg-[#090F22] rounded-2xl border border-slate-800/80 text-center">
            ...
            {/* Footer */}
            <footer className="py-20 px-6 border-t border-slate-900/50 bg-[#090F22]/80">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
                    <div className="flex flex-col items-center md:items-start gap-4">
                        <div className="flex items-center gap-3">
                            <Image src={LOGO_URL} alt="Bid Wars" width={120} height={32} className="h-8 w-auto grayscale opacity-50 object-contain" />
                        </div>
                    ...
                    <nav className="flex gap-4 sm:gap-6 text-[11px] font-black uppercase tracking-widest text-slate-500">
                        <Link href="/terms" className="md:hover:text-[#FBBF24] transition-colors">Terms of Service</Link>
                        <Link href="/privacy" className="md:hover:text-[#FBBF24] transition-colors">Privacy</Link>
                        <a href="mailto:support@bidwars.xyz" className="md:hover:text-[#FBBF24] transition-colors">Support</a>
                    </nav>
