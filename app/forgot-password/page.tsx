...
import { ArrowLeft, Mail, Loader2, CheckCircle2, ShieldCheck, User } from 'lucide-react';
...
export default function ForgotPasswordPage() {
    ...
    return (
        <div className="min-h-screen bg-[#020617] flex flex-col items-center justify-center p-6 relative overflow-hidden selection:bg-yellow-500/30">
            <div className="absolute top-[-10%] right-[-10%] w-[60%] h-[60%] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-400/15 via-blue-400/5 to-transparent rounded-full pointer-events-none" />
            <div className="absolute bottom-[-10%] left-[-10%] w-[60%] h-[60%] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-yellow-900/10 via-yellow-900/5 to-transparent rounded-full pointer-events-none" />
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        {mode === 'email' && (
                            <motion.div key="email" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.35, ease: EASE }} className="space-y-5">
                                ...
                                <button onClick={handleEmailReset} disabled={!email || loading} className="w-full bg-[#FBBF24] text-slate-950 font-black py-3.5 rounded-xl uppercase tracking-widest text-xs active:scale-95 transition-all disabled:opacity-40 flex items-center justify-center gap-2">
                            ...
                            <motion.div key="telegram" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.35, ease: EASE }} className="space-y-5">
                                ...
                                <div className="bg-blue-400/5 border border-blue-400/20 rounded-2xl p-3 flex items-center gap-3">
                                    ...
                                    <p className="text-[10px] text-slate-400 leading-relaxed">
                                        Enter your main account username. We'll send a reset link to your linked Telegram account.
                                    </p>
                                </div>
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-11 pr-4 py-3.5 bg-slate-950/50 border border-slate-800 rounded-xl text-white font-mono text-sm focus:border-blue-400 outline-none transition-all placeholder:text-slate-700"
                                ...
                                <button onClick={handleTelegramReset} disabled={!telegramUsername.trim() || loading} className="w-full bg-blue-400 text-slate-950 font-black py-3.5 rounded-xl uppercase tracking-widest text-xs active:scale-95 transition-all disabled:opacity-40 flex items-center justify-center gap-2">
